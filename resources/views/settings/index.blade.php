                        ...
                        <div class="mt-4 flex flex-col gap-5">
                            <div>
                                ...
                                <ol class="mt-2 flex list-decimal flex-col gap-2 pl-5">
                                    <li>Open <a href="https://console.cloud.google.com/auth/audience" target="_blank" rel="noopener" class="font-medium underline">Google Cloud → Audience ↗</a>. If <strong>Publishing status</strong> says <strong>In production</strong>, skip this step. If it says <strong>Testing</strong>, Google cancels this account's token after 7 days, so publish the app: if <strong>Publish app</strong> is grey, open <a href="https://console.cloud.google.com/auth/branding" target="_blank" rel="noopener" class="font-medium underline">Google Cloud → Branding ↗</a>, fill in <strong>App name</strong>, <strong>User support email</strong> and <strong>Developer contact information</strong>, click <strong>Save</strong>, and return to Audience. Click <strong>Publish app</strong>, then <strong>Confirm</strong>.</li>
