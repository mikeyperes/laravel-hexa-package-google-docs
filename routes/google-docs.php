...
use hexa_package_google_docs\Http\Controllers\GoogleDocsOAuthController;
...
Route::middleware(['web', 'auth', 'locked', 'system_lock', 'two_factor', 'role'])->group(function () {
    ...
    Route::get('/settings/google-docs/oauth/redirect', [GoogleDocsOAuthController::class, 'redirect'])->name('settings.google-docs.oauth.redirect');
    Route::get('/settings/google-docs/oauth/callback', [GoogleDocsOAuthController::class, 'callback'])->name('settings.google-docs.oauth.callback');
